...
<div id="layout-wrapper">
    ...
    <div class="main-content">
                                ...
                                <div class="modal-dialog modal-sm">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <button type="button" class="btn btn-primary theme-bg gradient button-ubah"
                                                id="button-ubah">Ubah</button>
                                        </div>
                                    </div><!-- /.modal-content -->
                                </div><!-- /.modal-dialog -->
                            </div><!-- /.modal -->
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <button type="button" class="btn btn-primary theme-bg gradient"
                                                id="button-import">Ya, Import!</button>
                                        </div>
                                    </div><!-- /.modal-content -->
                                </div><!-- /.modal-dialog -->
                            </div><!-- /.modal -->
        ...
        $(document).on('click', '#button-ubah', function(e) {
            ...
            $.ajax({
                url: "<?= route_to('users-ubah') ?>",
                type: "POST",
                data: data,
                // global: false,
                // async: false,
                beforeSend: function() {
                    $('#button-ubah').removeAttr('disable');
                    $('#button-ubah').html('<i class="fa fa-spin fa-spinner"></i>');
                },
                complete: function(e) {
                    $('#button-ubah').prop('disable', 'disable');
        ...
        $(document).on('click', '#button-hapus', function(e) {
            Swal.fire({
                ...
                if (result.value) {
                    var data = {
                        'id': $('#button-hapus').attr('data-id'),
                        'csrf_token_name': $('input[name=csrf_token_name]').val()
                    };
                    // console.log(data);
                    $.ajax({
                        url: "<?= route_to('users-hapus') ?>",
                        headers: {
                            'X-Requested-With': 'XMLHttpRequest'
                        },
                        data: data,
        ...
        $(document).on('click', '#button-reset', function(e) {
            ...
            $.ajax({
                url: "<?= route_to('users-reset-password') ?>",
                type: "POST",
                data: data,
                // global: false,
                // async: false,
