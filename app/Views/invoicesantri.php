    ...
    <div class="main-content">
        ...
        <div class="page-content">
            <div class="container-fluid">
                ...
                <div class="modal fade modal-bayar" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel"
                    aria-hidden="true">
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            <div class="modal-header">
...
$(document).ready(function() {
    ...
    $.ajax({
        url: "<?= route_to('invoice-santri/datatable') ?>",
        headers: {
...
$(document).on('click', '#button-bayar', function(e) {
    ...
    $('#total-pembayaran').text($(this).attr('data-nominal'));
    $('#nomor-invoice').text($(this).attr('data-id'));
    // console.log(data);
...
$(document).ready(function() {
    ...
    $('#allcheck').click(function() {
        ...
        var awal = 0;
        for (let i = 0; i < l; i++) {
            var first = $('.check' + i + ':checked').attr('data-id')
            if (first != undefined) {
                awal = i;
                // console.log(awal);
            }
            tagihan_id[i] = $('.check' + (i + 2) + ':checked').attr('data-id');
        }
    ...
    $(document).on('change', 'input[type="checkbox"]', function() {
        ...
        if (this.checked) {
            ...
            $('.button-checkout').html(
                '<button type="button" class="btn btn-primary waves-effect waves-light" id="button-checkout" data-bs-toggle="modal" data-bs-target=".modal-checkout"> <i class="uil uil-plus"> Checkout </i></button>'
                )
        } else {
            no--;
