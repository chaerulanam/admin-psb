                    ...
                    <div class="card bg-gradient-light">
                        ...
                        <div class="card-body p-4">
                            <div class="text-center mt-2">
                                ...
                                <p class="text-muted">Silakan masuk bagi yang telah memiliki akun, atau klik "Daftar
                                    Sekarang" bagi yang belum memilikinya.</p>
                            </div>
                            <div class="p-2 mt-4">
                                ...
                                <form action="<?= route_to('login') ?>" method="post">
                                    ...
                                    <div class="mt-4 text-center">
                                        ...
                                        <p class="mb-0">Belum punya akun ?<a href="<?= route_to('register') ?>">
                                                Daftar Sekarang !</a></p>
                                        <?php endif; ?>
                                    </div>
                                </form>
