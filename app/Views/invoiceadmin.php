    <div class="card-body">
        <div class="invoice-title">
            <h4 class="float-end font-size-16" id="no_invoice"><span class="badge bg-danger font-size-12 ms-2">Not
                    Paid</span></h4>
            <div class="mb-4">
        ...
        <div class="py-2">
            ...
            <div class="d-print-none mt-4">
                <div class="float-end">
                    <button type="button" class="btn btn-primary waves-effect waves-light" id="button-bayar"> <i
                            class="uil uil-plus"> Bayar
                        </i></button>
                </div>
            </div>
        </div>
