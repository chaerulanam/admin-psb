...
class CetakInvoice extends BaseController
{
    ...
    public function index()
    {
        ...
        $invoice = $this->invoiceModel
            ->select('users.id as userid, invoice.id as invoiceid, nominal, tagihan.id as tagihanid, nama_lengkap, nama_tagihan, master_tagihan.deskripsi as deskripsi, nominal as harga, no_invoice, invoice.status as statusinv')
