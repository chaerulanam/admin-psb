<div class="card">
    <div class="card-body">
        <h4 class="card-title mb-4">Form Pendaftaran Santri Baru</h4>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div>
                                <div class="d-flex align-items-start mt-2">
                                    <div class="mb-3 row">
                                        <label class="col-md-12 col-form-label">Jenjang Pendidikan yang Dipilih</label>
                                        <div class="col-md-12">
                            ...
                            <div>
                                <div class="d-flex align-items-start mt-2">
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-md-12">
                                            <select class="form-select" id="ukuran_baju">
                                                <option value=>Select</option>
                            ...
                            <div>
                                <div class="d-flex align-items-start mt-2">
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-md-20">
                                            <select class="form-select" id="provinsi" onclick="getKabupaten()">
                                                <option value=>Select</option>
                                            </select>
                                        </div>
                                    </div>
                            ...
                            <div>
                                <div class="d-flex align-items-start mt-2">
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-md-12">
                                            <select class="form-select" id="kabupaten" onclick="getkecamatan()">
                                            </select>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div>
                                <div class="d-flex align-items-start mt-2">
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-md-12">
                                            <select class="form-select" id="kecamatan" onclick="getdesa()">
                                            </select>
                                        </div>
                                    </div>
                                </div>
